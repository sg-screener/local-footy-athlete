...
export const CONDITIONING_TEMPLATES: readonly ConditioningTemplate[] = [
  ...
  },
  {
    ...
    baseUnit: 'distance',
    modalityNotes: 'Run-only: the prescription is distance-based. Use a same-quality time-based repeat-sprint template for machines.',
    frameworkCheck: 'IN BAND (4–10 s, 1:3–1:5)',
  ...
  },
  {
    ...
    baseUnit: 'time',
    modalityNotes: 'Bike, Air Bike, Row and Ski only. The Erg identity is never rendered as a run.',
  ...
  },
  {
    ...
    baseUnit: 'distance',
    modalityNotes: 'Run-only: the prescription is distance-based. Use a same-quality time-based anaerobic template for machines.',
  ...
  },
  {
    ...
    baseUnit: 'time',
    modalityNotes: 'Run-only: MAS is a running identity. Machine aerobic-power work uses a compatible time-based template.',
  ...
  },
  {
    ...
    baseUnit: 'distance',
    modalityNotes: 'Run-only: the prescription is distance-based. Use a same-quality time-based aerobic-power template for machines.',
    frameworkCheck: 'IN BAND (1–5 min, 1:1–2:1)',
  ...
  /* ── Aerobic Capacity ── */
  {
    ...
    baseUnit: 'time',
    modalityNotes: 'Run-only: the title and prescription are running-specific. Machine aerobic-capacity work uses a compatible template.',
  ...
  },
  {
    ...
    baseUnit: 'distance',
    modalityNotes: 'Run-only: the prescription is distance-based. Use a same-quality time-based aerobic-capacity template for machines.',

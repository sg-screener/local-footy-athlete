...
export const EXERCISE_CUES: Record<string, ExerciseCue> = {
  ...
  "Sleeper Stretch": {"primaryCue": "Lie on the target shoulder and gently lower the forearm.", "secondaryCue": "Stop at a mild stretch behind the shoulder, never the front."},
  "Foam Roller Thoracic Extension": {"primaryCue": "Reach the weight overhead as your upper back extends.", "secondaryCue": "Keep ribs tucked and avoid arching through the lower back."},
  '90/90 Breathing': {

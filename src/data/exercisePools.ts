...
export const MOBILITY_POOL: PoolExercise[] = [
  ...
  authoredExercise("sleeper-stretch", "Sleeper Stretch", []),
  authoredExercise("foam-roller-thoracic-extension", "Foam Roller Thoracic Extension", ["foam_roller", ["dumbbells", "barbell"]]),

...
export const EXERCISE_MUSCLE_METADATA: readonly ExerciseMuscleEntry[] = [
  {"exercise": "Incline Push-Up", "pool": "Upper push horizontal", "primary": ["Chest", "Triceps", "Shoulders"], "secondary": ["Midline", "Glutes"], "experienceGate": "everyone_regression", "note": "Automatic regression and manual Swap from Push-ups only. Eligible for all complete beginners and female athletes at 1–2 years. Requires a bench or plyo box. Bodyweight only; record support height in the session note and lower it to progress. Inherits Push-ups sets, reps and role. All phases; suitable near games.", "flagged": false},
  {"exercise": "Single-Leg Hop and Stick", "pool": "Power", "primary": ["Glutes", "Quads", "Calves"], "secondary": ["Hamstrings", "Groin", "Midline", "Feet"], "experienceGate": "two_plus_years", "note": "Automatic lower power and manual Add/Swap for 2+ years only. Bodyweight; 2 × 5 per side with 120 seconds rest. All phases and in-season at low volume; never automatic at G-1. Progress hop distance only while the landing stays controlled.", "flagged": false},
  {"exercise": "T-Bar Tib Raises", "pool": "Accessories lower", "primary": ["Calves"], "secondary": [], "experienceGate": "everyone", "note": "Tibialis anterior (shin). Requires a tib bar and compatible plates. Uses the Tib Raises dose: 2 × 15–20 reps with 30 seconds rest. Begin empty or light, record total external load, and retain full ankle range. Automatic progression from Tib Raises when available; manual Add/Swap. All phases; familiar light loading is suitable at G-1.", "flagged": false},
  {"exercise": "Band-Assisted Pull-Up", "pool": "Upper pull vertical", "primary": ["Lats", "Biceps", "Upper back"], "secondary": ["Shoulders", "Grip", "Midline"], "experienceGate": "everyone_regression", "note": "Automatic regression and manual Swap from Pull-Ups only. Eligible for all complete beginners and female athletes at 1–2 years. Requires a resistance band plus a rack or pull-up bar. Record band strength or colour and support height; reduce assistance to progress. Inherits Pull-Up sets, reps and role. All phases; suitable near games.", "flagged": false},
  ...
  },
  {
    ...
    experienceGate: 'one_plus_years',
    note: 'Available from 1+ years. Keep existing injury and equipment restrictions.',
    flagged: false,
  },
  {
  ...
  },
  {
    ...
    experienceGate: 'two_plus_years',
    note: 'Auto lower power. Bench; 2+ years. Not in-season or near games.',
    flagged: false,
  },
  {
    exercise: 'Explosive Push-up',

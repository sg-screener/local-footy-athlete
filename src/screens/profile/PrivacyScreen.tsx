...
export const PrivacyScreen: React.FC = () => {
  ...
  return (
    <ScreenContainer scrollable>
      ...
      <Text variant="body" style={styles.sectionContent}>
        Local Footy Athlete may use your name, footy role, training schedule, game day, experience level, body measurements, training preferences, workout activity, calendar changes, fatigue, injury context and coach chat messages.
      </Text>

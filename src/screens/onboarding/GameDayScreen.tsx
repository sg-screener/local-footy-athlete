 ...
 *
 * Visuals come from the shared <DayGrid /> and therefore match every other
 * onboarding weekday question and the in-app season-shift picker. This screen
 * remains single-select and advances immediately.
 */

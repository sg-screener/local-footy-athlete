 ...
 *   Accessories: 2-3 x 8-15 by default, with lower secondary work reduced
 *               in-season/pre-season; pump work 10-20; Nordics 2-3 x 3-5;
...
export const LOWER_SECONDARY_REP_GUIDELINES: Readonly<
  Record<SeasonPhase, AccessoryGuideline>
> = {
  'In-season': {
    setsMin: 2,
    setsMax: 3,
    ...
    max: 8,
    unit: 'reps',
    note: 'Low-soreness lower secondary work; controlled reps and no grinding.',
  },
  'Pre-season': {
    setsMin: 2,
    setsMax: 3,
    ...
    max: 10,
    unit: 'reps',
    note: 'Moderate lower secondary work; build capacity without excessive soreness.',
  },
  'Off-season': ACCESSORY_REP_GUIDELINES.general,
};

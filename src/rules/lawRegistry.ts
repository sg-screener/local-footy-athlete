...
export const LAW_REGISTRY: readonly LawRow[] = [
  ...
  },
  {
    ...
    law: 'Coach keeps Renee\'s My Status doorway at zero; My Status is the only home for Coach Notes and season phase; phase review lets the athlete choose any different phase before the phase-appropriate setup questions. Entering Off-season asks the finish date and availability but never team-training or game-day questions. Program carries none of that status UI.',
    ruledAt: 'NOT STATED IN THE REPO — Sam, 2026-08-11 in this Codex task: "it should open the status.... not just the coaches tab - and it should always be there"; then: "when you tap my status from hers you can see that the season phase is also there too"; then, 2026-08-11: "allow them to select which season they go to" while keeping the phase-appropriate setup questions, and "we no longer need coaches notes showing up on day page or weekly page". Updated by docs/RULINGS_REGISTRY.md R-247: Off-season explicitly skips team-training and game-day questions. This guarded registry row is the durable ruling site.',
    guard: {
      state: 'guarded',

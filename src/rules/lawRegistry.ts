...
export const LAW_REGISTRY: readonly LawRow[] = [
  ...
  },
  {
    ...
    law: 'Tapping the Week dots opens a sheet headed “Adjust this week”. Its first action-selection step asks “What do you want to change?”. Under “Schedule changes” it reads: “I have a bye” / “Remove this week’s game”; “Add a game” / “Add another game to this week”; and “I’m going away” / “Adjust around travel or time away”. A quiet divider and gap introduce “Training”, whose one row reads “Manage sessions” / “Add, move or remove training”. Its nested step reads: “Add a session” / “Put another session on a day this week”; “Move a session” / “Choose a session and move it to another day”; and “Remove a session” / “Choose a session to remove from the week”. Add a game is the one popup label in both competitive phases.',
    ruledAt: 'docs/RULINGS_REGISTRY.md R-201, R-202, R-204, R-205 and R-206 — Sam supplied the heading/question and option wording, grouped schedule changes apart from training, extended the heading to “Adjust this week”, then supplied the nested session-action explanations.',
    guard: {
      state: 'guarded',
      by: 'test:day-first-timeline',
      chainStatus: 'in_chain',
      receipt: 'BORN GUARDED 2026-08-25 by seat `headeralign`; corrected under the same R-201 minutes later and extended for R-202/R-204/R-205/R-206. The existing WeekEditSheet remains the one owner; its heading, first-step question, two section labels, four top-level option pairs and three nested session-action pairs read signed copy. The Week-edit cells in `test:day-first-timeline` require every signed value and binding, the requested section order, a quiet divider/gap, and the same action doors. Focused run: the R-206 nested-copy cell is green at the suite\'s inherited 54 passed / 2 failed baseline; the two reds still name mobility review wiring and an absent generated Gunshow fixture. NOT COVERED: screenshots, simulator interaction, physical iPhone, translated copy and completing a session mutation.',
    },
  },
];

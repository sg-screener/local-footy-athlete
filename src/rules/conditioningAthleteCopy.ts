...
export const CONDITIONING_ATHLETE_COPY: Readonly<Record<string, ConditioningAthleteCopy>> = {
  ...
  'Up-Back Shuttle': { title: 'Up-Back Shuttle', work: '30 m out + 30 m back', recovery: 'Start every 60 s', setsRounds: '15 reps', intensity: '7/10', cue: 'Plant cleanly and accelerate out of the turn.' },
  'Low-Intensity Deceleration Drills': { title: 'Low-Intensity Deceleration Drills', work: '20 m build-up + 3 m controlled stop', recovery: 'Start every 30 s', setsRounds: '10 reps', intensity: '4/10', cue: 'Lower your body and stop under control.' },
  ...
  '45-Degree Cut Reps': { title: '45-Degree Cut Reps', work: '10 m approach + cut + 10 m exit', recovery: 'Start every 60 s', setsRounds: '5 reps', intensity: '10/10', cue: 'Keep your plant foot underneath you.' },

/**
 * COMPATIBILITY ADAPTER, TEST SUPPORT ONLY — restored 2026-08-27.
 *
 * `screens/home/homeGameMutationController` was burned in 3f97cc67 (zero
 * production importers; canonical owner `store/fixtureMutationTransaction`),
 * but three fixture regression suites still imported it, so they have been
 * DYING AT IMPORT and reporting nothing since 2026-08-19. The module was
 * always a thin legacy-shape adapter over the canonical transaction — exactly
 * what those suites need — so it lives on here, in test support, where no
 * production code can reach it.
 */

...
export type Slice4RuleId =
  ...
  | 'ALL-COND-STRUCTURE-IDENTITY-01'
  | 'ALL-COND-PLACEMENT-IDENTITY-01'
  | 'ALL-COND-INTENT-HONEST-01'
...
export type Slice4InvariantId =
  ...
  | 'INV_WEEK_OVERLAY_COPY_CONSERVES_CONTRACT'

...
export const SLICE4_GOLDEN_SCENARIOS: readonly Slice4GoldenScenario[] = [
  ...
  scenario('standalone-conditioning-ownership', 'Modern standalone SkiErg tempo stays conditioning-only through deterministic and AI-fixture generation.', ['deterministic_generation', 'ai_fixture_normalisation'], ['ALL-COND-STANDALONE-OWNERSHIP-01', 'ALL-LEGACY-INFERENCE-BOUNDARY-01', 'ALL-COND-HEADLINE-01'], { components: ['conditioning'], headline: 'main_work' }),
];

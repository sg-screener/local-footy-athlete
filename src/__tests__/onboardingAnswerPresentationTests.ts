...
console.log('\n[0d] Welcome explains the complete LFA program');
{
  ...
  ok('the retired Welcome copy is absent',
    !/TRAIN FOR|Training built around your season\.|YOUR PROGRAM|YOUR SCHEDULE|Fits your week|YOUR BODY|Keeps you available|Everything works together|Built as one program|Train everything that matters|recovery specific to each phase of the season/.test(welcomeScreen));

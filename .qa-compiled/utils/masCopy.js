...
exports.MAS_FALLBACK_NOTE = void 0;
exports.masIntensityForWorkSeconds = masIntensityForWorkSeconds;
exports.masIntensityLabel = masIntensityLabel;
exports.masIntensityBlock = masIntensityBlock;
exports.masKmhToMs = masKmhToMs;
exports.estimateMasFromTimeTrial = estimateMasFromTimeTrial;
exports.masDistancePerRep = masDistancePerRep;
exports.masDistanceTolerance = masDistanceTolerance;
/** Percentage of MAS for a given work-interval length (in seconds). */
function masIntensityForWorkSeconds(workSeconds) {
    return workSeconds <= 30 ? 110 : 100;
}
/** Formatted label, e.g. "110% MAS" or "100% MAS". */
function masIntensityLabel(workSeconds) {
 ...
 */
exports.MAS_FALLBACK_NOTE = "If you don't know your MAS, tell the coach your recent 2km or 3km " +
 ...
 */
function masIntensityBlock(workSeconds, opts = {}) {
 ...
 */
function estimateMasFromTimeTrial(distanceKm, timeSeconds) {
 ...
 */
function masDistancePerRep(masKmh, workSeconds) {
    if (masKmh <= 0 || workSeconds <= 0)
        return 0;
 ...
 * matters less.
 */
function masDistanceTolerance(workSeconds) {

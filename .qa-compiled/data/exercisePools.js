...
exports.TRUNK_ANTI_ROTATION_POOL = [
    ...
    ex('half-kneel-chop', 'Half-Kneeling Cable or Band Chop', 2, 10, 12, 45, 'Controlled rotation. Light weight.', ['cables', 'bands'], ['lower_back'], 'low', { prescriptionType: 'reps', perSide: true }),

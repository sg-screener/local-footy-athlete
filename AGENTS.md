...
> **MOVED to `.claude/rules/coach-and-plan-edits.md`** on 2026-08-12 — it loads only when the
> files it governs are touched. **Nothing was deleted; if that mechanism is
> ever inert, read that file directly. It is tracked, not local.**

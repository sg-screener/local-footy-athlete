...
- `test:weekly-scheduler` now includes the production generated-world suite
  ...
  later-week recurrence are all guarded. The new suite is 7 of 7 green; the
...
- The generated fixture guard is green but its three mutations have not yet been
  run; mutation proof follows the clean checkpoint required by repo process.

...
## item 21 — original order, archived verbatim 2026-08-13

21. **ASSIGNED TO THE TERMINAL, AND ITS ONE NON-GENERATION ORDER IS ALREADY
    PAID.**
...
## ITEM 22 — CLOSED, archived verbatim

**Archived 2026-08-13 by the desktop agent.** (a) and (b) shipped `5ff77758`;
(c) was closed by item 28's away build and verified line by line — the question,
the routing, the copy and the rebuild all exist, and the 'three ways out' question
was answered by Sam himself. Moved out because `docs/SEAT_INBOX.md` is 17KB over
its 96KB stop budget, which Sam pays for in dollars.
...
## ITEM 25 — the floor measurement, archived verbatim

**Archived 2026-08-13 by the desktop agent.** Its question is VOID: R-014 rules
there is no floor because size is not the rule. The row-count measurement below is
kept in full because it is real data, but it counts the wrong unit — the unit is
PATTERN SLOTS (item 34). Moved out for the 96KB stop budget.
...
## item 28-C1 — original order, archived verbatim 2026-08-13

28-C1. **ITS QUESTION IS VOID AND ITS REMAINING WORK IS THE TERMINAL'S.**

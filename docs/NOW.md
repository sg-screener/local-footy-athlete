...
- **BRANCH:** `main` · **HEAD:** `e4ca0628` — **re-stamp this line at every checkpoint; it was four commits stale on 2026-08-10 and a stale HEAD makes every other line in this file unverifiable.**
...
- **THE UI MERGE — SLICES 2, 3 AND 5 LANDED** (`25565430`, `2752c90a`,
  ...
  SEVEN DAYS** (`e4ca0628`): large dates, compact badges, an acted active-
  modifier line, collapsed entry with today independently highlighted, and
  one-chevron flat full-session expansion are green on the simulator; Sam's
